...
try { 
    ...
    alert("Erro crítico: Firebase não conectou.");
}
        ...
        methods: {
            ...
            carregarDb() { 
                ...
                if(db) { 
                    ...
                    db.ref('system/feriados').on('value', s => { this.feriados = s.val() ? Object.values(s.val()) : []; if(this.fer