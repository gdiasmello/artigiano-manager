...
const app = createApp({
    ...
    methods: {
        ...
        adicionarProduto() {
            ...
            if(this.novoProd.locaisSelecionados.length === 0) return alert("Selecione Locais!");
        ...
        migrarProduto(p) {
            ...
            if (typeof p.contagem !== 'object' && p.locais && p.locais.length > 0) { const val = p.contagem; p.contagem = {}; if(val !== '' && val !== undefined) p.contagem[p.locais[0]] = val; mudou = true; }
        ...
        abrirAjuda() { this.tituloAjuda = "Ajuda"; this.textoAjuda = "Use 'Importar Agenda' para facilitar cadastro de contatos.\nUse '+0.5' para itens abertos.\nO sistema soma quantidades se o item estiver em 2 lugares."; this.mostrandoAjuda = true; },
