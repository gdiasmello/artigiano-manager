// --- CONFIGURAÇÃO DO SEU FIREBASE (JÁ PREENCHIDA) ---
...
try {
    ...
    alert("Erro de conexão. O app funcionará offline.");
}
...
const app = createApp({
    ...
    methods: {
        ...
        tentarLogin() {
            // Se não tiver usuários cadastrados (primeiro acesso), libera admin padrão 1234
            if (this.usuarios.length === 0 && this.pinDigitado === '1234') {
                this.usuarioLogado = { nome: 'Admin Inicial' };
                this.pinDigitado = '';
                return;
            }
        ...
        abrirAjuda(contexto) {
            ...
            if(contexto === 'inicio') this.textoAjuda = "<b>Escolha o Modo:</b><br>🥕 <b>Sacolão:</b> Filtra apenas hortifruti.<br>📦 <b>Geral:</b> Queijos, carnes, insumos.<br>🍕 <b>Tudo:</b> Lista completa.";
            if(contexto === 'lista') this.textoAjuda = "<b>Como contar:</b><br>1. Digite a quantidade no campo.<br>2. Se estiver OK, use 🚫 para ignorar.<br>3. Use o lápis para editar.<br>4. O sistema arredonda sempre para cima.";
            if(contexto === 'envio') this.textoAjuda = "<b>Revisão:</b><br>O app separa os pedidos por fornecedor. Clique em 'Enviar WhatsApp' para finalizar.";
            if(contexto === 'config') this.textoAjuda = "<b>Configurações:</b><br>Cadastre Usuários (PIN), Produtos e Lembretes aqui.";
        },
